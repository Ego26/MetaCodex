...
ns.RegisterLocale("deDE", {
    ...
    ["PROBE_TALENTS"] = "Talentvergleich: %d von %d Knoten des Builds erkannt, du hast %d gewählt",
    ["PROBE_TALENTS_UNKNOWN"] = "im Baum nicht gefunden: %s",
    ["PROBE_TALENTS_DIFF"] = "Unterschied: %d fehlen, %d zusätzlich, %d gleich",
    ["PROBE_TALENTS_NONE"] = "Talentvergleich: der Client gibt deine Wahl nicht her",
    ["PROBE_TALENTS_NOBUILD"] = "Talentvergleich: für diese Ansicht gibt es keinen Build",
