...
ns.RegisterLocale("deDE", {
    ...
    ["PROBE_MEMORY"] = "Speicher nach dem Aufräumen: %.1f MB (%s, in MB)",
...
ns.RegisterLocale("deDE", {
    ...
    ["SECTION_priority"] = "Prioritäten",
    ["PRIO_HINT"]      = "Was dir fehlt, geordnet nach dem Anteil der Besten, die es tragen. Keine Schadensrechnung - gezählt wird, wer es anhat.",
    ["PRIO_NONE"]      = "Nichts offen: Verbrauchsgüter, Verzauberungen und Steine sind da.",
    ["PRIO_ENCHANT"]   = "Verzauberung",
    ["PRIO_GEM"]       = "Stein",
    ["PRIO_NOPCT"]     = "ohne Messung",
...
ns.RegisterLocale("deDE", {
    ...
    ["ORIGIN_GALL_dungeon"] = "Alle Dungeons",
    ["ORIGIN_GALL_raid"]    = "Alle Schlachtzüge",
    ["ORIGIN_GALL_other"]   = "Alles Sonstige",
    ...
    ["PLAYER_PROFILE_GROUP"] = "Profil",
    ["PLAYER_PROFILE"]    = "Link zum Profil",
