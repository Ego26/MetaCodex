...
ns.RegisterLocale("enUS", {
    ...
    ["PROBE_TALENTS"] = "Talent comparison: %d of %d build nodes recognised, you picked %d",
    ["PROBE_TALENTS_UNKNOWN"] = "not found in the tree: %s",
    ["PROBE_TALENTS_DIFF"] = "Difference: %d missing, %d extra, %d the same",
    ["PROBE_TALENTS_NONE"] = "Talent comparison: the client does not give up your choice",
    ["PROBE_TALENTS_NOBUILD"] = "Talent comparison: no build for this view",
