...
ns.RegisterLocale("enUS", {
    ...
    ["CONSUM_TARGET_OWN"] = "Another number…",
    ["CONSUM_HINT"] = "Click an item to set how many you want, or to say which one you use.",
    ["NUMBER_OK"] = "Apply",
    ...
    ["SECTION_priority"] = "Priorities",
    ["PRIO_HINT"]      = "What you are missing, ordered by the share of the best players who wear it. Not a damage estimate - it counts who has it on.",
    ["PRIO_NONE"]      = "Nothing open: consumables, enchants and gems are there.",
    ["PRIO_ENCHANT"]   = "Enchant",
    ["PRIO_GEM"]       = "Gem",
    ["PRIO_NOPCT"]     = "not measured",
    ...
    ["REMIND_WIN_NONE"] = "nothing in your bags",
...
ns.RegisterLocale("enUS", {
    ...
    ["ORIGIN_GALL_dungeon"] = "All dungeons",
    ["ORIGIN_GALL_raid"]    = "All raids",
    ["ORIGIN_GALL_other"]   = "Everything else",
    ...
    ["PLAYER_PROFILE_GROUP"] = "Profile",
    ["PLAYER_PROFILE"]    = "Link to the profile",
