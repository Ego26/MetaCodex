...
ns.RegisterLocale("enUS", {
    ...
    ["SLASH_SCALE"]        = "/mc scale 0.6-1.6 - size of the window (1 = normal)",
    ["SCALE_SET"]          = "Window scale: %s",
...
ns.RegisterLocale("enUS", {
    ...
    ["REMIND_OPT_ENTER"] = "Chat line on entering a dungeon or raid",
...
ns.RegisterLocale("enUS", {
    ...
    ["TALENT_PICKS"] = "Where opinions differ",
    ["TALENT_RANK"]  = "Rank %d",
})
